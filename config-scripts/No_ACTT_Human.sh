...
## below is the information for No-ACTT human cells covid-19 for SEM_protein region

forward=TTATCTTGGCAAACCACGCGAACA
forwardPrimer_RC=TGTTCGCGTGGTTTGCCAAGATAA
